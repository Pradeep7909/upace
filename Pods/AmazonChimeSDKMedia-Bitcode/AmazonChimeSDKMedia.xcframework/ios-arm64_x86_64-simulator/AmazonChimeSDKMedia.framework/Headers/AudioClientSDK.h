...
@interface AppInfo: NSObject
    ...
    @property NSString *clientUtcOffset;
- (id) initWithAppName:(NSString *)appName
       ...
       clientUtcOffset:(NSString *)clientUtcOffset;
@end
...
// startSession that passes config knob to enable audio redundancy
- (audio_client_status_t)startSession:(NSString *)host
                ...
                enableAudioRedundancy:(BOOL)enableAudioRedundancy
;
