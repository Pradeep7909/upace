...
- (audio_client_status_t)startSession:(NSString * _Null_unspecified)host basePort:(NSInteger)port callId:(NSString * _Null_unspecified)callId profileId:(NSString * _Null_unspecified)profileId microphoneMute:(BOOL)mic_mute speakerMute:(BOOL)spk_mute isPresenter:(BOOL)presenter sessionToken:(NSString * _Null_unspecified)tokenString audioWsUrl:(NSString * _Null_unspecified)audioWsUrl callKitEnabled:(BOOL)callKitEnabled appInfo:(AppInfo * _Null_unspecified)appInfo audioMode:(AudioModeInternal)audioMode enableAudioRedundancy:(BOOL)enableAudioRedundancy SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly) BOOL enableAudioRedundancy;
@property (nonatomic, readonly, strong) VideoResolution * _Nonnull videoMaxResolution;
...
- (nonnull instancetype)initWithEnableAudioRedundancy:(BOOL)enableAudioRedundancy;
- (nonnull instancetype)initWithVideoMaxResolution:(VideoResolution * _Nonnull)videoMaxResolution;
- (nonnull instancetype)initWithAudioMode:(enum AudioMode)audioMode callKitEnabled:(BOOL)callKitEnabled;
- (nonnull instancetype)initWithAudioMode:(enum AudioMode)audioMode callKitEnabled:(BOOL)callKitEnabled enableAudioRedundancy:(BOOL)enableAudioRedundancy;
- (nonnull instancetype)initWithAudioMode:(enum AudioMode)audioMode callKitEnabled:(BOOL)callKitEnabled enableAudioRedundancy:(BOOL)enableAudioRedundancy videoMaxResolution:(VideoResolution * _Nonnull)videoMaxResolution OBJC_DESIGNATED_INITIALIZER;
...
enum BackgroundBlurStrength : NSInteger;

SWIFT_CLASS("_TtC14AmazonChimeSDK27BackgroundBlurConfiguration")
@interface BackgroundBlurConfiguration : NSObject
- (nonnull instancetype)initWithLogger:(id <Logger> _Nonnull)logger blurStrength:(enum BackgroundBlurStrength)blurStrength OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// <code>BackgroundBlurVideoFrameProcessor</code> is a processor which receives video frames via <code>VideoSource</code> and
/// then applies Gaussian blur to each video frame and renders the foreground on top of the blurred image.
/// Gaussian blur is applied using built in <code>CIGaussianBlur</code> CIFilter.
SWIFT_CLASS("_TtC14AmazonChimeSDK33BackgroundBlurVideoFrameProcessor")
@interface BackgroundBlurVideoFrameProcessor : NSObject <VideoSink, VideoSource>
@property (nonatomic) enum VideoContentHint videoContentHint;
/// Public constructor to initialize the processor.
/// \param backgroundBlurConfiguration <code>BackgroundBlurConfiguration</code> class.
///
- (nonnull instancetype)initWithBackgroundBlurConfiguration:(BackgroundBlurConfiguration * _Nonnull)backgroundBlurConfiguration OBJC_DESIGNATED_INITIALIZER;
...
/// \param newBlurStrength New blur intensity value.
///
- (void)setBlurStrengthWithNewBlurStrength:(enum BackgroundBlurStrength)newBlurStrength;
/// Adds a video sink to the sinks set.
- (void)addVideoSinkWithSink:(id <VideoSink> _Nonnull)sink;
/// Remove a video sink from the sinks set.
- (void)removeVideoSinkWithSink:(id <VideoSink> _Nonnull)sink;
/// Update the <code>VideoSink(s)</code> with a new frame.
/// \param frame Next frame to render.
///
- (void)updateSinksWithFrame:(VideoFrame * _Nonnull)frame;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param mediaDevice Video capture device to query
///
+ (NSArray<VideoCaptureFormat *> * _Nonnull)listSupportedVideoCaptureFormatsWithMediaDevice:(MediaDevice * _Nonnull)mediaDevice videoMaxResolution:(VideoResolution * _Nonnull)videoMaxResolution SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithExternalMeetingId:(NSString * _Nullable)externalMeetingId mediaPlacement:(MediaPlacement * _Nonnull)mediaPlacement meetingFeatures:(MeetingFeatures * _Nonnull)meetingFeatures mediaRegion:(NSString * _Nonnull)mediaRegion meetingId:(NSString * _Nonnull)meetingId primaryMeetingId:(NSString * _Nullable)primaryMeetingId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC14AmazonChimeSDK15MeetingFeatures")
@interface MeetingFeatures : NSObject
@property (nonatomic, readonly, strong) VideoResolution * _Nonnull videoMaxResolution;
@property (nonatomic, readonly, strong) VideoResolution * _Nonnull contentMaxResolution;
- (nonnull instancetype)init;
- (nonnull instancetype)initWithVideo:(NSString * _Nullable)video content:(NSString * _Nullable)content;
- (nonnull instancetype)initWithVideoMaxResolution:(VideoResolution * _Nonnull)videoMaxResolution contentMaxResolution:(VideoResolution * _Nonnull)contentMaxResolution OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, strong) MeetingFeatures * _Nonnull meetingFeatures;
...
- (nonnull instancetype)initWithMeetingId:(NSString * _Nonnull)meetingId externalMeetingId:(NSString * _Nullable)externalMeetingId credentials:(MeetingSessionCredentials * _Nonnull)credentials urls:(MeetingSessionURLs * _Nonnull)urls urlRewriter:(NSString * _Nonnull (^ _Nonnull)(NSString * _Nonnull))urlRewriter meetingFeatures:(MeetingFeatures * _Nonnull)meetingFeatures;
...
- (nonnull instancetype)initWithMeetingId:(NSString * _Nonnull)meetingId externalMeetingId:(NSString * _Nullable)externalMeetingId credentials:(MeetingSessionCredentials * _Nonnull)credentials urls:(MeetingSessionURLs * _Nonnull)urls urlRewriter:(NSString * _Nonnull (^ _Nonnull)(NSString * _Nonnull))urlRewriter primaryMeetingId:(NSString * _Nullable)primaryMeetingId;
- (nonnull instancetype)initWithMeetingId:(NSString * _Nonnull)meetingId externalMeetingId:(NSString * _Nullable)externalMeetingId credentials:(MeetingSessionCredentials * _Nonnull)credentials urls:(MeetingSessionURLs * _Nonnull)urls urlRewriter:(NSString * _Nonnull (^ _Nonnull)(NSString * _Nonnull))urlRewriter primaryMeetingId:(NSString * _Nullable)primaryMeetingId meetingFeatures:(MeetingFeatures * _Nonnull)meetingFeatures OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14AmazonChimeSDK21VideoBitrateConstants")
@interface VideoBitrateConstants : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
