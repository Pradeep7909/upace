...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AmazonChimeSDK-Bitcode/AmazonChimeSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AmazonChimeSDKMedia-Bitcode/AmazonChimeSDKMedia.framework"
fi
